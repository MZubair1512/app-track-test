...
const Add = () => {
  ...
  return (
    ...
    <div className="w-2/4 mx-[5%] my-[2%]">
      <InputField handleChange={handleChangeCompany} label={"Company"} color='black' placeholder='Example: Abc Limited'></InputField>
      ...
      <div className='my-3'></div>
      <InputField handleChange={handleChangePosition} label={"Position"} color='black' placeholder='Example: Software Engineer'></InputField>
      <div className='my-3'></div>
      ...
      <div className='my-3'></div>
      <TextArea handleChange={handleChangeDetails} label={"Interview Details"} color='black' placeholder='Enter Details About Interview'></TextArea>
      <div className='my-3 '></div>
      <button onClick={()=>postApplication(status,company,position,interviewdt,interviewDetail,email)} className="inline-flex border-2 font-[PoppinsBold] border-slate-900 text-white bg-indigo-500 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-md">
          Add Application
      </button>
    </div>
    </>
